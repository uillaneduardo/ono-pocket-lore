...
A Coluna concentra três funções ao mesmo tempo:

- **sobrevivência**, porque mantém condições ambientais essenciais;
- **mistério**, porque sua função original foi esquecida ou ocultada;
- **dependência**, porque a sociedade atual não possui meios simples de substituir seus sistemas.

!!! warning "Verdade de autor"
    A origem orbital, o êxodo e a administração por um Ono antigo não devem ser tratados como conhecimento cotidiano da população no início do jogo.
